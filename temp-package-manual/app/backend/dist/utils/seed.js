...
async function seedStores() {
    ...
    for (const store of stores) {
        await dataService_1.dataService.create('stores', store);
    }
...
async function seedProducts() {
    ...
    for (const product of products) {
        await dataService_1.dataService.create('products', product);
    }
...
async function seedGlobalSnapshot() {
    ...
    await dataService_1.dataService.create('global_snapshots', snapshot);
...
async function seedSalesSnapshot() {
    ...
    await dataService_1.dataService.create('sales_snapshots', snapshot);
...
async function seedDailySales() {
    ...
    for (const dailySale of dailySalesData) {
        await dataService_1.dataService.create('daily_sales', dailySale);
    }
