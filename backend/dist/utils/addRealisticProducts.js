...
exports.addRealisticProducts = addRealisticProducts;
exports.addRealisticProductsToAllStores = addRealisticProductsToAllStores;
...
async function addRealisticProducts(storeId) {
    ...
    for (let i = 0; i < realisticProducts.length; i++) {
        ...
        try {
            const createdProduct = await dataService_1.dataService.create('products', product);
